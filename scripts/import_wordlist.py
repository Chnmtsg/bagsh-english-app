...
def main() -> int:
    ...
    data = {
        ...
        "note": ("COVERAGE ONLY, NOT A LEVEL AUTHORITY (ADR-0005). Frequency "
                 "ranking over a written corpus with heavy legal/governmental "
                 "content: it has no entry for bread, milk, eat or hungry, and "
                 "puts shall, upon and county at A2. knowledge/vocabulary.yaml "
                 "decides what level a word is; these bands only measure how "
                 "much of a frequency ranking a learner recognises."),
        "levels": levels,
    }
