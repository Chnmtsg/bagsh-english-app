...
| `src/chunks.py` | Word partners (ADR-0014): 300 prepositions and collocations as typed clozes. Teaches what the error queue may not drill — `prepositions` and `collocation` stay untreatable as ERRORS; this is the other half, teaching the phrase before it goes wrong. |
